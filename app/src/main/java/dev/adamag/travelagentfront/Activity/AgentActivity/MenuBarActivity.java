...
import dev.adamag.travelagentfront.Activity.AuthActivity.LoginActivity;
import dev.adamag.travelagentfront.Activity.NotificationActivity.NotificationActivity;
...
public abstract class MenuBarActivity extends AppCompatActivity {
    ...
    protected void setupBottomNavigationBar() {
        ...
        findViewById(R.id.homeButton).setOnClickListener(v -> navigateTo(DisplayAgentPackages.class));
        findViewById(R.id.ticketButton).setOnClickListener(v -> navigateTo(AddPackageActivity.class));
        findViewById(R.id.notificationButton).setOnClickListener(v -> navigateTo(NotificationActivity.class));
        findViewById(R.id.bagButton).setOnClickListener(v -> navigateTo(DisplayAgentPackages.class));
    }
